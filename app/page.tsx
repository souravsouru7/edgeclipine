  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <main className="relative z-10">
        ...
        {/* ════════════════════ HERO ════════════════════ */}
        <section ref={heroRef} className="min-h-screen flex flex-col items-center justify-center pt-28 pb-16 px-5 sm:px-8 text-center relative grid-lines overflow-hidden">
          <motion.div style={{ y: heroY, opacity: heroOpacity }} className="flex flex-col items-center w-full max-w-5xl mx-auto">
            ...
            {/* Hero CTA removed for pure awareness page */}
