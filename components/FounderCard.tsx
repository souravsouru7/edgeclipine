...
export default function FounderCard({ founder, priority = false }: FounderCardProps) {
  const { name, role, image, bio, responsibilities, linkedin, email } = founder;
  ...
  return (
    <article className="group flex h-full flex-col rounded-3xl border border-white/[0.07] bg-white/[0.02] p-6 md:p-8 hover:border-white/[0.14] transition-colors duration-300">
      ...
      <h2 className="text-[clamp(20px,2.4vw,26px)] font-extrabold tracking-tight text-white mb-2">
        {name}
      </h2>
